...
public class calcoloPercorsoEsame extends AbstractPlugIn {
	...
	public boolean execute(PlugInContext arg0) throws Exception {  
		...
		// System.out.println("layer selezionati: "+layer_rimessa+" "+layer_strade+" "+layer_segnalazioni);
		// Feature starter_point=layer_rimessa.getFeatureCollectionWrapper().getFeatures().get(0);
		// System.out.println("starter point "+starter_point.getAttribute(0));

		// addPointStrade(arg0, layer_strade);
