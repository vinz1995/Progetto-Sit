...
<main class="flex-shrink-0">
  ...
  <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
    ...
    <img class="map" src="http://localhost:8080/geoserver/Strade/wms?service=WMS&version=1.1.0&request=GetMap&layers=Strade%3AStrade&bbox=1725279.8899999997%2C5029716.77%2C1729471.25%2C5034134.539999999&width=728&height=768&srs=EPSG%3A3003&styles=&format=image%2Fpng">
